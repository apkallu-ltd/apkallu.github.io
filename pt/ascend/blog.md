...
ref: blog
title: Blog — Ascend
permalink: /pt/ascend/blog
page: blog
---

<header class="modern-header">
  <div class="container">
    <h1>Blog do Ascend</h1>
    <p>Dicas, reflexões e histórias sobre crescimento pessoal, produtividade e desafios comunitários.</p>
  </div>
</header>
  ...
  {% for post in filtered_posts %}
    <div class="modern-card">
      ...
      {% if diff_seconds < ten_days_seconds %}
        <div class="new-badge">{{ i18n.blog.new_badge | default: "Novo" }}</div>
      {% endif %}
      ...
      <div class="card-content">
        ...
        <div class="card-footer">
          ...
          <a href="{{ post.url | relative_url }}" class="card-link">{{ i18n.blog.read_more | default: "Ler mais →" }}</a>
        </div>
      </div>
    </div>
  {% endfor %}
