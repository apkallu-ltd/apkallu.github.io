...
<header class="modern-header">
  <div class="container">
    ...
    <p>How Ascend collects, uses, and protects your information.</p>
...
<div class="legal-layout">
  ...
  <aside class="legal-toc">
    <h4>Contents</h4>
    <ul>
      <li><a href="#1-what-information-do-we-collect">1. Information We Collect</a></li>
      <li><a href="#2-how-do-we-process-your-information">2. How We Process It</a></li>
      <li><a href="#3-what-legal-bases-do-we-rely-on-to-process-your-information">3. Legal Bases</a></li>
      <li><a href="#4-when-and-with-whom-do-we-share-your-personal-information">4. Sharing Your Info</a></li>
      <li><a href="#5-what-is-our-stance-on-third-party-websites">5. Third-Party Sites</a></li>
      <li><a href="#6-do-we-use-cookies-and-other-tracking-technologies">6. Cookies & Tracking</a></li>
      <li><a href="#7-how-do-we-handle-your-social-logins">7. Social Logins</a></li>
      <li><a href="#8-is-your-information-transferred-internationally">8. International Transfers</a></li>
      <li><a href="#9-how-long-do-we-keep-your-information">9. Retention</a></li>
      <li><a href="#10-how-do-we-keep-your-information-safe">10. Data Security</a></li>
      <li><a href="#11-do-we-collect-information-from-minors">11. Minors</a></li>
      <li><a href="#12-what-are-your-privacy-rights">12. Your Rights</a></li>
      <li><a href="#13-controls-for-do-not-track-features">13. Do-Not-Track</a></li>
      <li><a href="#14-do-united-states-residents-have-specific-privacy-rights">14. US Residents</a></li>
      <li><a href="#15-do-other-regions-have-specific-privacy-rights">15. Other Regions</a></li>
      <li><a href="#16-do-we-make-updates-to-this-notice">16. Policy Updates</a></li>
      <li><a href="#17-how-can-you-contact-us-about-this-notice">17. Contact Us</a></li>
      <li><a href="#18-how-can-you-review-update-or-delete-the-data-we-collect-from-you">18. Your Data Rights</a></li>
    </ul>
  </aside>
...
This privacy notice for APKALLU LTD ('**Company**', '**we**', '**us**', or '**our**') describes how and why we might collect, store, use, and/or share ('**process**') your information when you use our services ('**Services**'), such as when you download and use the Ascend mobile application.

**Questions or concerns?** Contact us at [help@apkallu.co.uk](mailto:help@apkallu.co.uk).
</div>

<div class="legal-summary" markdown="1">
...
**What personal information do we process?** Account information, user interest and self-improvement tags, AI Coach intake responses (goals, time commitment, constraints, and barriers), AI-generated habit plan data produced by the Gemini LLM, and structured analytics event data. Learn more about [personal information you disclose to us](#personal-information-you-disclose-to-us).

**Do we process any sensitive personal information?** We do not process sensitive personal information.

**Do we collect any information from third parties?** We do not collect any information from third parties.

**How do we process your information?** To provide, improve, and administer our Services, for security and fraud prevention, and to comply with law. Learn more about [how we process your information](#2-how-do-we-process-your-information).

**With whom do we share personal information?** We may share information in specific situations with specific categories of third parties. Learn more about [when and with whom we share your personal information](#4-when-and-with-whom-do-we-share-your-personal-information).

**How do we keep your information safe?** We have organisational and technical processes in place, though no transmission over the internet can be guaranteed 100% secure. Learn more about [how we keep your information safe](#10-how-do-we-keep-your-information-safe).

**What are your rights?** Depending on your location, you may have certain rights regarding your personal information. Learn more about [your privacy rights](#12-what-are-your-privacy-rights).

</div>

<a id="1-what-information-do-we-collect"></a>
...
* bio
* profile pictures
* user interest and self-improvement tags (goal categories and topic preferences
selected during onboarding and in your account settings)
* AI Coach intake responses (your goal, time commitment, constraints, and
barriers — entered as free-text or chip selections during the AI Life Coach
intake conversation)
...
* _Push Notifications and Interactive Local Notifications._ We may request to send
you push notifications regarding your account or certain features of the
application(s). In addition to standard push notifications, the app schedules
local device alarms based on your subscribed plan and challenge task
schedules. Where you have granted notification permission, these local
notifications may include interactive actions — for example, marking a task as
complete directly from your device lock screen via our notification action
handler. To support this functionality, the app maintains a diff-based alarm
registry on your device, which stores lightweight task identifiers (hashes) to
determine which alarms need to be created, updated, or removed. This registry
is stored entirely on-device and is not transmitted to our servers. If you wish to
opt out from receiving these types of communications, you may turn them off in
your device's settings.
* _AI Life Coach Data._ When you use the AI Life Coach feature, we process: (a)
the free-text and chip-selected answers you provide during the intake
conversation (covering your goal, availability, lifestyle constraints, and barriers);
(b) the structured habit plan template generated on your behalf by Google's
Gemini large language model; and (c) metadata recording the AI generation
credits you consume and the daily replenishment of those credits. Your intake
answers are transmitted to the Google Gemini API in order to generate your
personalised plan (see
'[WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?](#4-when-and-with-whom-do-we-share-your-personal-information)'
below). The generated plan content is then stored in your account.
* _Offline and Local Storage._ The app caches your calendar data — including task
schedules and check-in states — locally on your device to support offline
operation. If you complete a task or make a check-in while offline, the
corresponding sync payload is queued on-device and transmitted to our servers
once a network connection is restored. This local cache is controlled by your
device and is not transmitted until network access is available.
...
<a id="2-how-do-we-process-your-information"></a>
...
* **To generate AI-powered personalised habit plans.** We process the intake
responses you provide through the AI Life Coach (covering your goal,
availability, lifestyle constraints, and barriers) to instruct Google's Gemini
large language model to produce a structured habit plan template tailored to
you. This processing occurs each time you initiate an AI Coach generation
request.
* **To manage AI generation credits and prevent abuse.** We process usage
metadata — including the number of AI generation requests you have made
and the timestamp of your last replenishment — to enforce per-user daily credit
limits and system-wide quota caps. This prevents platform abuse and helps us
manage our third-party API costs responsibly.
* **To send you interactive local notifications.** We process your subscribed
plan and challenge task schedules to schedule local device alarms at the
appropriate times. Where you have granted notification permission, we also
process this schedule data to enable direct task-completion actions from your
device lock screen.
* **To personalise content discovery.** We process your declared interest
categories and self-improvement tags to surface relevant plans and challenges
in the Discovery Feed. Content ranking uses database-level tag-matching and
a Hot Score algorithm that weighs recency, engagement, and relevance to your
declared interests.
...
<a id="3-what-legal-bases-do-we-rely-on-to-process-your-information"></a>
...
<a id="4-when-and-with-whom-do-we-share-your-personal-information"></a>
...
* **Google Gemini API (Google LLC).** When you use the AI Life Coach feature,
your intake answers (including your goal text, lifestyle constraints, and
barriers) are transmitted to the Google Gemini API operated by Google LLC.
Google processes this data on our behalf solely to generate the personalised
habit plan content you have requested. This processing is governed by
Google's terms of service and Google's privacy policy. Our broader use of
Google APIs is also subject to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including
...
<a id="5-what-is-our-stance-on-third-party-websites"></a>
...
<a id="6-do-we-use-cookies-and-other-tracking-technologies"></a>
...
'[DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?](#14-do-united-states-residents-have-specific-privacy-rights)'

### Firebase Analytics

We use Firebase Analytics, provided by Google LLC, to collect structured in-app
event data that helps us understand how users interact with the Services and improve
the overall experience. The events we collect include, but are not limited to:
`AI_COACH_OPENED`, `AI_COACH_ENGAGED`, `AI_COACH_GENERATION_TRIGGERED`,
`AI_COACH_PLAN_REVEALED`, `AI_COACH_PLAN_SAVED`, `AI_COACH_DISMISSED`,
`GOAL_SELECTED`, `BADGE_UNLOCKED`, `NOTIFICATION_CLICKED`, and
`UNIVERSAL_LINK_RECEIVED`. Analytics collection is gated on GDPR-compliant
consent checks implemented via our `AnalyticsHandler` — no analytics events are
recorded until you have been presented with and accepted the relevant consent
prompt. For more information on Google's privacy practices, please visit the
[Google Privacy & Terms page](https://policies.google.com/privacy).

### Firebase Crashlytics

We use Firebase Crashlytics, provided by Google LLC, to collect anonymised crash
reports and stability diagnostics. When the app encounters an unexpected error or
crash, Crashlytics captures technical information about the failure (such as the stack
trace, device model, and operating system version) to help us identify and resolve
issues quickly. Crashlytics does not collect personal identifying information such as
your name or email address. As with Firebase Analytics, Crashlytics data collection
is gated on GDPR-compliant consent checks — diagnostics are not transmitted until
you have provided the relevant consent. For more information, please visit the
[Google Privacy & Terms page](https://policies.google.com/privacy).

<a id="7-how-do-we-handle-your-social-logins"></a>
...
<a id="8-is-your-information-transferred-internationally"></a>
...
<a id="9-how-long-do-we-keep-your-information"></a>
...
In addition to the general retention periods above, the following specific categories of
data are subject to the retention periods set out below:

* **AI usage logs** — Records of AI Coach generation requests, credit
consumption, and daily replenishment events are retained for the duration of
your account. This data is necessary to enforce per-user daily credit limits,
prevent abuse of the generation system, and correctly calculate credit
replenishment. Upon account deletion, these logs are deleted or anonymised
in accordance with our standard deletion procedures.
* **SSV transaction identifiers** — Server-Side Verification transaction IDs
associated with rewarded ad interactions are retained for a reasonable period
after each transaction for the purpose of preventing replay attacks and
duplicate credit awards. Once the replay-attack risk window has passed, these
identifiers are deleted.
* **Local device data** (alarm registry and offline task cache) — Data stored
locally on your device, including the diff-based notification alarm registry and
any queued offline task-completion payloads, is retained on your device until
the app is uninstalled or you delete your account via your account settings.
This data is under your device's control and is not accessible to us unless
and until it is transmitted to our servers.

<a id="10-how-do-we-keep-your-information-safe"></a>
...
<a id="11-do-we-collect-information-from-minors"></a>
...
Please note that the AI Life Coach feature collects goal and lifestyle data (including
personal goals, daily availability, self-reported constraints, and barriers) that may be
particularly sensitive for younger users. The 18+ age requirement set out in our Terms
of Service applies with full force to this feature, and we rely on that age gate to
prevent the collection of such data from minors.

<a id="12-what-are-your-privacy-rights"></a>
...
<a id="13-controls-for-do-not-track-features"></a>
...
<a id="14-do-united-states-residents-have-specific-privacy-rights"></a>
...
|F. Internet or other similar network activity| Browsing history, search history, online behaviour, interest data, and interactions with our and other websites, applications, systems, and advertisements. We collect structured in-app event sequences via Firebase Analytics (e.g. AI Coach interactions, goal selections, badge unlocks, notification clicks) that fall within this category.| YES |
|G. Geolocation data| Device location| NO|
|H. Audio, electronic, sensory, or similar information| Images and audio, video or call recordings created in connection with our business activities| NO |
|I. Professional or employment-related information | Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us| NO |
|J. Education Information| Student records and directory information| NO|
|K. Inferences drawn from collected personal information | Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual's preferences and characteristics. We derive interest-based profiles from your declared self-improvement tags and use a Hot Score ranking algorithm to personalise content discovery. | YES |
...
* Category F - As long as the user has an account with us (Firebase Analytics event data is subject to Google's standard data retention settings)
* Category K - As long as the user has an account with us (interest tags and personalisation profiles are deleted upon account deletion)
...
* Category F. Internet or other similar network activity (Firebase Analytics event data shared with Google LLC)
* Category K. Inferences (interest-tag profiles used for content personalisation)
...
profiling by adjusting your consent preferences directly within the App's settings,
...
<a id="15-do-other-regions-have-specific-privacy-rights"></a>
...
<a id="16-do-we-make-updates-to-this-notice"></a>
...
<a id="17-how-can-you-contact-us-about-this-notice"></a>
...
<a id="18-how-can-you-review-update-or-delete-the-data-we-collect-from-you"></a>
