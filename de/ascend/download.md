...
lang: de
ref: download
title: Ascend herunterladen
permalink: /de/ascend/download
...
<header class="modern-header">
  <div class="container">
    ...
    <h1>Starte mit Ascend</h1>
    <p>Deine Reise zu nachhaltigen Gewohnheiten beginnt hier. Jetzt auf allen gängigen Plattformen verfügbar.</p>
  </div>
</header>
    ...
    <div class="modern-post-container" style="text-align: center;">
      ...
      <div id="recommended-section" style="margin-bottom: 60px; display: none;">
        <p style="font-size: 1.3rem; margin-bottom: 30px; color: #2c3e50;">
          Wir haben erkannt, dass du <span id="device-type" style="font-weight: 700;">ein Mobilgerät</span> nutzt.
        </p>
        <a id="recommended-store" href="#" class="join-btn" style="padding: 22px 60px; font-size: 1.4rem;">
          <i class="fas fa-download" style="margin-right: 12px;"></i> <span id="store-text">Jetzt herunterladen</span>
        </a>
      </div>

      <div class="cta-box" style="margin-top: 0; padding: 60px 40px; background-color: #fcfcfc;">
        <h2 style="font-weight: 900; margin-bottom: 20px; color: #001A33;">Wähle deine Plattform</h2>
        <p style="color: #666; margin-bottom: 40px; font-size: 1.1rem;">Klicke auf die Buttons unten, um Ascend zu installieren und dich unserer wachsenden Community anzuschließen.</p>
      ...
      <div style="margin-top: 80px;">
        <h3 style="font-weight: 900; margin-bottom: 25px;">Warum Ascend?</h3>
        <div class="modern-grid" style="padding-top: 0; margin-bottom: 0;">
          <div class="modern-card" style="padding: 30px; text-align: center;">
            ...
            <h4 style="font-weight: 800;">Gemeinschaft</h4>
            <p style="font-size: 0.95rem; margin-bottom: 0;">Challenges gemeinsam meistern</p>
          </div>
          <div class="modern-card" style="padding: 30px; text-align: center;">
            <i class="fas fa-calendar-check" style="font-size: 2rem; color: #8BC34A; margin-bottom: 15px;"></i>
            <h4 style="font-weight: 800;">Fortschritt</h4>
            <p style="font-size: 0.95rem; margin-bottom: 0;">Tägliches Gewohnheits-Tracking</p>
          </div>
          <div class="modern-card" style="padding: 30px; text-align: center;">
            <i class="fas fa-medal" style="font-size: 2rem; color: #FFE573; margin-bottom: 15px;"></i>
            <h4 style="font-weight: 800;">Erfolge</h4>
            <p style="font-size: 0.95rem; margin-bottom: 0;">Sammle digitale Abzeichen</p>
          </div>
        </div>
      </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (isIOS) {
    ...
    deviceTypeEl.textContent = 'ein iOS-Gerät';
    recommendedStore.href = "{{ site.app.app_store }}";
    storeText.textContent = 'Im App Store herunterladen';
  } else if (isAndroid) {
    recommendedSection.style.display = 'block';
    deviceTypeEl.textContent = 'ein Android-Gerät';
    recommendedStore.href = "{{ site.app.google_play }}";
    storeText.textContent = 'Jetzt bei Google Play';
  }
});
</script>
