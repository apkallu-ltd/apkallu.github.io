...
<a href="{{ 'ascend/shared?type=plan&id=59' | relative_url }}" class="floating-btn pulse">
  Start Plan Now
</a>
...
[Click here to start the Second Brain Builder plan on Ascend]({{ 'ascend/shared?type=plan&id=59' | relative_url }})
...
[Click here to join the Second Brain Builder plan and start Day 1 now]({{ 'ascend/shared?type=plan&id=59' | relative_url }})
